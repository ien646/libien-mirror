...
namespace ien
{
    ...
    {
        IEN_RESTRICT_INTEGRAL<TInt8>();
        IEN_RESTRICT_SIZE<TInt8, 1>();
    ...
    {
        IEN_RESTRICT_INTEGRAL<TInt16>();
        IEN_RESTRICT_INTEGRAL<TInt8>();
        IEN_RESTRICT_SIZE<TInt16, 2>();
        IEN_RESTRICT_SIZE<TInt8, 1>();
    ...
    {
        IEN_RESTRICT_INTEGRAL<TInt32>();
        IEN_RESTRICT_INTEGRAL<TInt16>();
        IEN_RESTRICT_SIZE<TInt32, 4>();
        IEN_RESTRICT_SIZE<TInt16, 2>();
    ...
    {
        IEN_RESTRICT_INTEGRAL<TInt64>();
        IEN_RESTRICT_INTEGRAL<TInt32>();
        IEN_RESTRICT_SIZE<TInt64, 8>();
        IEN_RESTRICT_SIZE<TInt32, 4>();
